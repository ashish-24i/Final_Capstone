...
exports.getAllVideo = async (req, res) => {
    ...
    try {
        ...
        const videos = await Video.find().populate('user', 'channelName profilePic userName')
...
exports.getVideoById = async (req, res) => {
    try {
        ...
        const video = await Video.findById(id).populate('user', 'channelName profilePic userName');
...
exports.getAllVideoByUserId = async (req, res) => {
    ...
    try {
        ...
        const video = await Video.find({ user: userId }).populate('user', 'channelName profilePic userName about');
